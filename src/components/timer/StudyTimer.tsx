        ...
        >
          ...
          <div className="flex justify-center gap-3 sm:gap-4">
            ...
            <Button
              onClick={handleReset}
              variant="outline"
              className="text-sm sm:text-base border-border text-foreground hover:bg-muted"
            >
              Reset
            </Button>
          </div>
          ...
          <Progress
            ...
            className={cn(
              "mt-4 bg-input",
              timer.mode === 'focus' ? "[&>div]:bg-primary" : "[&>div]:bg-secondary"
            )}
          />
        </div>

        <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4 text-foreground">
          <div>
            ...
            >
              <SelectTrigger className="mt-1 bg-input text-foreground border-border">
                <SelectValue />
              </SelectTrigger>
              <SelectContent className="bg-card text-foreground border-border">
                {[15, 25, 30, 45, 60].map((time) => (
                  <SelectItem key={time} value={time.toString()} className="hover:bg-muted">
                    {time} minutes
                  </SelectItem>
                ))}
              </SelectContent>
