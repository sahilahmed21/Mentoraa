...
export default function StudyPlanForm({ onPlanGenerated }: StudyPlanFormProps) {
  ...
  return (
    <div className="w-full bg-[#393E46] p-6 rounded-lg shadow-md">
      <div className="max-w-6xl mx-auto">
        <form onSubmit={handleSubmit} className="space-y-6 mb-8">
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1 space-y-2">
              <Input
                ...
                className={cn(
                  "bg-[#222831] text-[#EEEEEE] border border-[#00ADB5] placeholder-[#EEEEEE]/50 text-lg p-6 rounded-md h-auto",
                  "focus:ring-2 focus:ring-[#00ADB5] focus:border-[#00ADB5]",
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant={"outline"}
                    className={cn(
                      "w-full h-full justify-start text-left font-normal bg-[#222831] text-[#EEEEEE] border border-[#00ADB5] text-lg p-6 rounded-md",
                      !date && "text-[#EEEEEE]/50"
                    )}
                  >
                ...
                <PopoverContent className="w-auto p-0 bg-[#222831] border border-[#00ADB5]" align="start">
                  <Calendar
                    mode="single"
                    selected={date}
                    onSelect={setDate}
                    ...
                    className="bg-[#222831] text-[#EEEEEE]"
                  />
                </PopoverContent>
              </Popover>
            </div>
          ...
          <div className="flex justify-center w-full">
            <Button
              type="submit"
              className="w-full sm:w-auto flex justify-center items-center text-lg py-6 px-8 rounded-md bg-[#00ADB5] text-[#EEEEEE] hover:bg-[#00ADB5]/80 transition-colors"
        ...
        {plan && (
          <div className="mt-8 bg-[#222831] text-[#EEEEEE] rounded-lg border border-[#00ADB5] p-6 shadow-md">
            <h3 className="text-xl font-semibold mb-4 text-[#00ADB5]">Generated Study Plan</h3>
