  ...
  return (
    <div className="container mx-auto p-4 sm:p-6">
      <div className="flex justify-between items-center mb-4 sm:mb-6">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground">Notes</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6">
        ...
        <div className={`${showSidebar ? 'block' : 'hidden'} md:block md:col-span-3`}>
          <Card className="h-[calc(100vh-16rem)] md:h-[calc(100vh-12rem)] overflow-y-auto border-2 border-primary rounded-lg">
