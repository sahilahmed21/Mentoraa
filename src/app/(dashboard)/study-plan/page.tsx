  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 bg-[#393E46] text-[#EEEEEE]">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-[#EEEEEE] mb-2 sm:mb-0">Study Plan Generator</h1>
        <div className="flex items-center gap-4">
          <span className="text-xs sm:text-sm text-[#EEEEEE] opacity-60">Create and manage your study plans</span>
        </div>
      </div>
      ...
      <div id="stored-plans" className="mt-8 sm:mt-12">
        ...
        <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-[#EEEEEE]">Your Study Plans</h2>
