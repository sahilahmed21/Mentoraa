...
export default function ResourcesPage() {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 bg-[#393E46] text-[#EEEEEE]">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-[#EEEEEE]">Resource Curator</h1>
        <div className="flex items-center">
          <span className="text-xs sm:text-sm text-[#EEEEEE] opacity-60">Find and manage learning resources</span>
        </div>
      </div>
      ...
      {loading ? (
        <div className="mt-8 sm:mt-12">
          <Separator className="my-6 sm:my-8 bg-[#00ADB5]" />
          <Skeleton className="h-6 sm:h-8 w-36 sm:w-48 mb-4 sm:mb-6 bg-[#222831]" />
          <div className="space-y-4 sm:space-y-6">
            <Skeleton className="h-[150px] sm:h-[200px] w-full bg-[#222831]" />
            <Skeleton className="h-[150px] sm:h-[200px] w-full bg-[#222831]" />
          </div>
        </div>
      ) : (
        <div id="stored-resources" className="mt-8 sm:mt-12">
          <Separator className="my-6 sm:my-8 bg-[#00ADB5]" />
          <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-[#EEEEEE]">Your Curated Resources</h2>
          {storedResources.length > 0 ? (
            ...
            <div className="text-center py-8 text-[#EEEEEE] opacity-60">
